  ...
  try {
    ...
    try {
      ...
      for (let i = 0; i < validData.length; i += batchSize) {
        ...
        console.log(`Batch inserted: ${result.length} records, Total so far: ${totalInserted}`);
      }
  ...
  try {
    ...
    try {
      ...
      for (let i = 0; i < validData.length; i += batchSize) {
        ...
        totalInserted += result.length;
        console.log(`Batch appended: ${result.length} records, Total appended so far: ${totalInserted}`);
      }
