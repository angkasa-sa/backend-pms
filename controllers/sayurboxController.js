  ...
  try {
    ...
    try {
      ...
      res.status(200).json({
        ...
        unmatchedExcelCodes: unmatchedExcelCodes.slice(0, 100),
        unmatchedSayurboxCodes: unmatchedSayurboxCodes.slice(0, 100),
        hasMoreUnmatchedExcel: unmatchedExcelCodes.length > 100,
        hasMoreUnmatchedSayurbox: unmatchedSayurboxCodes.length > 100
      });
