...
const startServer = async () => {
  try {
    ...
    app.listen(port, "0.0.0.0", () => {
      ...
      console.log(`   - GET /api/driver/data (Get all driver data)`);
      console.log(`   - PUT /api/driver/data/:id (Update driver data)`);
      console.log(`   - DELETE /api/driver/data/:id (Delete driver data)`);
      console.log(`   - DELETE /api/driver/data/bulk-delete (Bulk delete drivers)`);
      console.log(`   - POST /api/mitra/upload (Upload mitra data)`);
      console.log(`   - GET /api/mitra/data (Get all mitra data)`);
      console.log(`   - PUT /api/mitra/data/:id (Update mitra data)`);
      console.log(`   - DELETE /api/mitra/data/:id (Delete mitra data)`);
      console.log(`   - DELETE /api/mitra/data/bulk-delete (Bulk delete mitra)`);
      console.log(`   - POST /api/shipment/upload (Upload shipment data)`);
      console.log(`   - GET /api/shipment/data (Get all shipment data)`);
      console.log(`   - PUT /api/shipment/data/:id (Update shipment data)`);
      console.log(`   - DELETE /api/shipment/data/:id (Delete shipment data)`);
      console.log(`   - DELETE /api/shipment/data/bulk-delete (Bulk delete shipment)`);
